...
-- Tripulante para American Airlines (98765432109876)
INSERT INTO tb_tripulantes VALUES (tp_tripulante('66677788833', 'Isabela', 'Gomes', 'isabela.gomes@email.com', TO_DATE('1993-06-30', 'YYYY-MM-DD'), tp_telefone('23232323', '1', '1'), tp_telefones_varray(tp_telefone('24242424', '1', '1')), tp_endereco('56789123', 'Street E', 800, 'Miami', 'FL'), (SELECT REF(c) FROM tb_companhias_aereas c WHERE c.cnpj = '98765432109876'), NULL, tp_funcao_salario_base(1, 'Piloto', 10000.00), 203, TO_DATE('2020-06-30', 'YYYY-MM-DD'), 5));
INSERT INTO tb_tripulantes VALUES (tp_tripulante('77788899944', 'William', 'Taylor', 'william.taylor@email.com', TO_DATE('1989-11-28', 'YYYY-MM-DD'), tp_telefone('123456789', '1', '1'), tp_telefones_varray(tp_telefone('987654321', '1', '1')), tp_endereco('12345678', 'Street F', 1000, 'Chicago', 'IL'), (SELECT REF(c) FROM tb_companhias_aereas c WHERE c.cnpj = '98765432109876'), (SELECT REF(t) FROM tb_tripulantes t WHERE t.cpf = '66677788833'), tp_funcao_salario_base(2, 'Copiloto', 9000.00), 204, TO_DATE('2022-01-10', 'YYYY-MM-DD'), 5));
/
